...
/* Data Types:
    To avoid compiler issues, define the data types that need ot be used for 8b,
  16b and 32b in <core_portme.h>.

    *Important*:
    ee_ptr_int needs to be the data type used to hold pointers, otherwise
  coremark may fail!!! 2022-07-26: New compile-time macro POINTER_TYPE specified
  to allow this to be passed in from a makefile
*/
...
/* align_mem:
    This macro is used to align an offset to point to a 32b value. It is used in
   the Matrix algorithm to initialize the input memory blocks.
*/
...
/* Configuration: MULTITHREAD
   ...
   parallel contexts must be defined.
    ...
    Two sample implementations are provided. Use <USE_PTHREAD> or <USE_FORK> to
   enable them.

    It is valid to have a different implementation of <core_start_parallel> and
   <core_end_parallel> in <core_portme.c>, to fit a particular architecture.
*/
#ifndef MULTITHREAD
...
/* Configuration: USE_PTHREAD
    ...
    Note:
    This flag only matters if MULTITHREAD has been defined to a value greater
   then 1.
*/
#ifndef USE_PTHREAD
